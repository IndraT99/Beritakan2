            ...
            <div class="card-body">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link" id="nav-upload-video-tab" data-bs-toggle="tab"
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
            ...
            <div class="offcanvas-body">
                <div class="mb-5">
                    ...
                    {{ Form::select('openai', \App\Models\Post::MODEL, \App\Models\Post::GPT_3_5_TURBO, ['class' => 'form-select form-select-solid', 'id' => 'openAi', 'data-control' => 'select2']) }}
